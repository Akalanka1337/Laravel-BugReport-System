...
{
    public function setupDatabase($tableData)
    {
    ...
    public function listRouteNames()
    {
        ...
        foreach ($allRoutes as $route) {
            if (strpos($route->getName(), 'dashboard.') !== false && strpos($route->getName(), '.index') !== false) {
                $name = str_replace('dashboard.', '', $route->getName());
