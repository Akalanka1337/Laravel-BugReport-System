...
use App\Http\Requests\Dashboard\Admins\AdminsRequest;
...
class AdminsController extends Controller
{
    public function index()
    {
        ...
        return view("dashboard.admins.index")->with(compact('admiko_data', "tableData"));
    }
    ...
    public function create()
    {
        ...
        $admiko_data['sideBarActive'] = "admikoAdmins";
        $admiko_data['sideBarActiveFolder'] = "";
        $admiko_data['formAction'] = route("dashboard.admins.store");
        ...
        return view("dashboard.admins.manage")->with(compact('admiko_data', 'role_all', 'themes', 'multi_tenancy_all'));
    }
    ...
    public function edit(Admins $Admins)
    {
        ...
        $admiko_data['sideBarActive'] = "admikoAdmins";
        $admiko_data['sideBarActiveFolder'] = "";
        $admiko_data['formAction'] = route("dashboard.admins.update", $Admins->id);
        if ($Admins->id == 1) {
        ...
        $data = $Admins;
        $multi_tenancy_all = Admins::all()->sortBy("name")->pluck("name", "id");
        return view("dashboard.admins.manage")->with(compact('admiko_data', 'data', 'role_all', 'AdminsRole', 'themes', 'multi_tenancy_all'));
    }
