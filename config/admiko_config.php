 ...
 */
/**
 * @param length_menu_table        php pagination limits
 * @param length_menu_table_JS     JS pagination limits
 ...
 * @param backup_location          Backup location to store old files when updating admiko default files
 */
return [
    'length_menu_table'        => [10 => 10, 50 => 50, 100 => 100, 99999 => "All"],
    'length_menu_table_JS'      => '[[10, 50, 100, -1], [10, 50, 100, "All"]]',
    'filesystem'             => 'public_folder',
    'table_date_time_format' => 'M d, Y H:i:s',
    'form_date_time_format'  => 'MMM DD, Y HH:mm:ss',
    'table_date_format'      => 'M d, Y',
    'form_date_format'       => 'MMM DD, Y',
